...
export default function LoginPage() {
  ...
  return (
    <div className="auth-layout">
      ...
      <aside className="auth-visual"><p className="eyebrow">SMART DEAL WORKSPACE</p><h2>메일 속 제안을<br />실제 수익으로 연결하세요.</h2><p>흩어진 협찬과 외주 메일을 한곳에 모으고, 놓치기 쉬운 조건과 일정을 Duepick이 정리합니다.</p><div className="auth-steps"><span className="auth-step">01 메일 전달</span><span className="auth-step">02 조건 확인</span><span className="auth-step">03 거래 관리</span><span className="auth-step">04 입금 완료</span></div></aside>
    </div>
  );
}
